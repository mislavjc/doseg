...
function RouteHint({ isTouch }: { isTouch: boolean }) {
  return (
    <motion.div
...
function OnboardingContent({ isTouch }: { isTouch: boolean }) {
  return (
    <>
...
function DialogPortalContent({ isTouch }: { isTouch: boolean }) {
  return (
    <Dialog.Portal keepMounted>
      ...
      >
        <OnboardingContent isTouch={isTouch} />
      </Dialog.Popup>
    </Dialog.Portal>
  )
}
...
export function OnboardingDialog() {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={dismiss}>
      <AnimatePresence>
        {open && <DialogPortalContent isTouch={isTouch} />}
      </AnimatePresence>
    </Dialog.Root>
  )
}
