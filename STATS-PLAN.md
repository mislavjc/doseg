...
- BAJS bike-share boost analysis
...
| 2.6  | BAJS first/last-mile coverage | "X% of transit stops within 350m of a BAJS station"                      | [ ]    |
| 2.7  | BAJS station density          | Stations/km², per 10k residents per district                             | [ ]    |
...
| #   | Feature                       | Description                                                                | Status |
| --- | ----------------------------- | -------------------------------------------------------------------------- | ------ |
| 4.1 | GTFS-RT persistence (SQLite)  | Snapshot every 60s → enables ALL historical analyses                       | [ ]    |
...
| 4.4 | Animated vehicle map          | Real-time dots on MapLibre — the single most visually impressive feature   | [ ]    |
...
| ---- | ------------------------------------------------------- | ------------- | ------ |
| V.1  | Animated live vehicle map (MapLibre + GTFS-RT)          | Yes           | [ ]    |
| V.2  | Network map colored by metric (speed/headway/frequency) | Yes           | [ ]    |
| V.3  | Marey diagrams for tram lines                           | Yes           | [ ]    |
| V.4  | Small multiples (hourly departure histograms per route) | Yes           | [ ]    |
...
| E.4 | OG image per metric (social sharing)  | [ ]    |
