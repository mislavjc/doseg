      ...
      <svg width="160" height="160" viewBox="0 0 160 160" fill="none">
        ...
        {rings.map((ring, i) => (
          <motion.circle
            ...
            fill="none" stroke={ring.color} strokeWidth="1.5" strokeOpacity={ring.opacity}
        ...
        {labels.map((t, i) => (
          <motion.text
            key={i}
            x="80" y={t.y} textAnchor="middle"
            fill={t.color} fontSize="8" fontWeight="500"
            ...
            >
              ...
              <div className="px-5 pt-4 pb-4">
                ...
                <Dialog.Description className="mt-1 text-center text-[13px] leading-snug text-slate-400">
                  Obojene linije pokazuju dokle možeš stići
                  tramvajem i busom u 15, 30 ili 45 minuta.
                </Dialog.Description>
                ...
                <div className="mt-4 flex flex-col gap-2">
                  ...
                  >
                    <div className="flex shrink-0 items-center gap-1">
                      ...
                      <span className="ml-0.5 text-[12px] font-semibold tabular-nums text-slate-300">
                        23 min
                      </span>
                    </div>
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      <div className="flex flex-col items-center">
                        <div className="relative h-[15px] overflow-hidden">
                          ...
                          >
                            <span className="block h-[15px] text-[12px] tabular-nums leading-[15px] text-slate-400">
                              08:30
                            </span>
                            <span className="block h-[15px] text-[12px] tabular-nums leading-[15px] text-slate-200">
                              14:00
                            </span>
                          </motion.div>
                        </div>
                        <span className="text-[8px] text-slate-600">polazak</span>
                      </div>
                      <div className="w-[60px]">
                        ...
                        />
                        <div className="mt-px flex justify-between text-[7px] tabular-nums text-slate-600">
                          <span>0</span>
                          <span>15</span>
                          <span>30</span>
                          <span>45</span>
